...
class HighScore:
    ...
    def start(self,score):   
        ...
        #now we draw background
        pygame.draw.rect(self.screen, (255, 255, 255), pygame.Rect(0, 0, self.SCREEN_W, self.SCREEN_H))  
            
        # this is showing Highscore Table
        self.scoretable = ""
        
        # thiss is  contains data the html to be parsed on to the screen. This section sets up the table and the table headers
        ...
        #Now that we have  finished readin from the highscores, save it back to the .txt file
        self.hiScore.save()

        # this is Display the table until the user exits
