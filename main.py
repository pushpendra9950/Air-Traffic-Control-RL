...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser("Configuration overrides for testing purposes.")      # Initialize the command line parser
    args = getArgs(parser)           # Get the arguments 
    override_config(args)            # Make the necessary changes to the game configuration
